...
// Get module APIs for direct usage in main.js
const ui = kernel.getModule('ui')
const { getMinSize, buildAppMenu, readWindowState, trackWindowState, setupEditableContextMenu } = ui
const minSize = getMinSize()

const updater = kernel.getModule('updater')

const profilesApi = kernel.getModule('profiles')

const settingsApi = kernel.getModule('settings')

// ─────────────────────────────────────────────────────────────────
// Config builders (pure)
// ─────────────────────────────────────────────────────────────────

const buildWindowConfig = (size) => ({
  ...size,
