...
type CodeVariant = 'inline' | 'mermaid' | 'block'
...
function hasLanguageToken(className: string, token: string): boolean {
...
export function CodeBlock({ node, className, children }: CodeBlockProps) {
