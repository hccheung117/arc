 ...
 */
export function AttachmentImage({ attachment, conversationId }: AttachmentImageProps) {
 ...
 */
export function AttachmentGallery({ attachments, conversationId }: AttachmentGalleryProps) {
  return (
